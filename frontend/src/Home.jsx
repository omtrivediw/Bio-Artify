...
const Home = () => {
  return (
    <div>
      ...
      <NavBar />
      <div className='flex h-96 mt-11 text-white w-4xl'>
        <div className='h-80 mx-auto w-2/5 p-5 bg-gray-900 rounded-[30px] flex-wrap'>
            ...
            <p className='mt-12 text-lg opacity-85 w-inherit flex-wrap'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae, earum facere consequatur natus unde quam corrupti maiores exercitationem et perspiciatis. Numquam est, voluptatem natus saepe ipsam iusto voluptatibus voluptate animi.</p>
